...
},{}],"yApQ":[function(require,module,exports) {
"use strict";
...
var chapter = function chapter(idx) {
  ...
  var endTime = startTime + minutes(10) - 1;
  var chapter_number = idx + 1;
  return {
    startTime: startTime,
    endTime: endTime,
    id: "chapter-".concat(chapter_number),
    title: "Chapter ".concat(chapter_number),
    description: "Some details about Chapter ".concat(chapter_number)
  };
};
...
var seek_to_chapter = function seek_to_chapter(chapter) {
...
//# sourceMappingURL=app.9e81e94d.js.map